...
export const amenities: Amenity[] = [
	{
		...
		icon: "wifi",
		title: "Internet",
		summary: "Wifi network and password — tap to copy below.",
		body: [
	...
	},
	{
		...
		body: [
			"Water: whole-house shutoff is in the utility/laundry room closet — low on the wall next to the water heater.",
	...
	},
	{
		...
		body: [
			...
			"Watch the fire at all times, especially in wind. Keep chairs and other items a safe distance away. Make sure the fire is out before you leave — and never leave it unattended.",
		],
	},
	{
		id: "hottub",
