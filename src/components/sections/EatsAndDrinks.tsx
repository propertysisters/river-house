  ...
  return (
    <Section id="eats">
      ...
      <p className={classes.subintro}>
        A bit further afield, but all locally beloved.
      </p>
      ...
      <p className={classes.note}>
        Hours and availability change with the seasons — a quick call or search
        before you head out is always worth it.{' '}
        <a
        ...
        >
          More options on Google Maps{' '}
          <IconArrowUpRight size={13} stroke={1.75} />
        </a>
      </p>
    </Section>
  );
